...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .requestMatchers(HttpMethod.POST,"/medicalRecords/delete").hasAnyAuthority("ROLE_ADMIN", "ROLE_DOCTOR", "ROLE_NURSE")
                .requestMatchers("/payments/receipt/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_RECEPTIONIST","ROLE_PATIENT")
                .requestMatchers("/payments").hasAnyAuthority("ROLE_ADMIN", "ROLE_RECEPTIONIST","ROLE_PATIENT")
                .requestMatchers("/payments/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_RECEPTIONIST","ROLE_PATIENT")
                ...
                .requestMatchers("/medicalRecords/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_DOCTOR", "ROLE_NURSE")
                ...
                .requestMatchers("/prescriptions/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_DOCTOR", "ROLE_NURSE", "ROLE_PHARMACIST")
